...
class _EducationScreenState extends State<EducationScreen> {
  ...
  void initState() {
    ...
    bloc = context.read<EducationBloc>();
    bloc.add(EducationFetched());
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          BlocProvider.of<EducationBloc>(context).setPage = 0;
